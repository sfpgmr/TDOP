...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(program) {return new ProgramNode(program.filter(n=>n));},
      ...
      peg$c365 = function(statementList) {return extractList(statementList,1).filter(n=>n);},
      peg$c366 = function(expression) { 
